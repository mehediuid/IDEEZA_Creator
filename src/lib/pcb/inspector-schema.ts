    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "addBom", label: "Add into BOM", kind: "toggle", display: "Yes" },
      ...
      },
      {
        ...
        fields: [
          { key: "manufacturer", label: "Manufacturer", kind: "text", display: "—" },
          { key: "manufacturerPart", label: "Manufacturer Part", kind: "text", display: "—" },
          { key: "supplier", label: "Supplier", kind: "text", display: "—" },
          { key: "supplierPart", label: "Supplier Part", kind: "text", display: "—" },
        ],
      },
    ...
    sections: [
      {
        title: "Basic Properties",
        fields: [
          { key: "pinName", label: "Pin Name", kind: "text", display: "—" },
          { key: "pinNumber", label: "Pin Number", kind: "text", display: "1" },
          { key: "id", label: "ID", kind: "readonly", display: "—" },
          { key: "pinType", label: "Pin Type", kind: "dropdown", options: PIN_TYPES, display: "Undefined" },
          { key: "pinShape", label: "Pin Shape", kind: "dropdown", options: PIN_SHAPES, display: "Line" },
          { key: "noConnectFlag", label: "No Connect Flag", kind: "toggle", display: "Off" },
        ],
      },
      { title: "More Properties", fields: [{ key: "addProperty", label: "Add Property", kind: "action", display: "+ Add" }] },
    ],
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "type", label: "Type", kind: "dropdown", options: ["Signal", "Power", "Ground"], display: "Signal" },
        ],
      },
      { title: "More Properties", fields: [{ key: "addProperty", label: "Add Property", kind: "action", display: "+ Add" }] },
      { title: "Group", fields: [{ key: "group", label: "Group", kind: "action", display: "Group" }] },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "lineStyle", label: "Line Style", kind: "dropdown", options: LINE_STYLES, display: "Solid" },
          { key: "strokeColor", label: "Stroke Color", kind: "color", bind: "obj:color", display: "#1E1E1E" },
          { key: "fillColor", label: "Fill Color", kind: "color", display: "#FFFFFF" },
          { key: "fillColor2", label: "Fill Color", kind: "color", display: "#FFFFFF" },
          { key: "roundRadius", label: "Round Radius (Rectangle)", kind: "number", unit: "mm", display: "0" },
          { key: "rectWidth", label: "Width (Rectangle)", kind: "number", unit: "mm", display: "0" },
          { key: "rectHeight", label: "Height (Rectangle)", kind: "number", unit: "mm", display: "0" },
          { key: "circleRadius", label: "Radius (Circle)", kind: "number", unit: "mm", display: "0" },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "font", label: "Font", kind: "dropdown", options: ["Inter", "Arial", "Roboto", "Courier"], display: "Inter" },
          { key: "fontSize", label: "Font Size", kind: "number", unit: "px", display: "12" },
          { key: "style", label: "Style", kind: "dropdown", options: FONT_STYLES, display: "Normal" },
          { key: "origin", label: "Origin", kind: "dropdown", options: ORIGINS, display: "Top Left" },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        fields: [
          { key: "name", label: "Name", kind: "text", bind: "obj:net", display: "—" },
          { key: "id", label: "ID", kind: "readonly", display: "—" },
          { key: "globalNetName", label: "Global Net Name", kind: "text", display: "—" },
          { key: "relevance", label: "Relevance", kind: "readonly", display: "—" },
    ...
    sections: [
      {
        ...
        fields: [
          { key: "allOn", label: "All On", kind: "toggle", display: "On" },
          { key: "fComponents", label: "Components", kind: "toggle", display: "On" },
          { key: "fWires", label: "Wires", kind: "toggle", display: "On" },
          { key: "fBuses", label: "Buses", kind: "toggle", display: "On" },
          { key: "fSheetSymbols", label: "Sheet Symbols", kind: "toggle", display: "On" },
          { key: "fSheetEntries", label: "Sheet Entries", kind: "toggle", display: "On" },
          { key: "fNetLabels", label: "Net Labels", kind: "toggle", display: "On" },
          { key: "fParameters", label: "Parameters", kind: "toggle", display: "On" },
          { key: "fPorts", label: "Ports", kind: "toggle", display: "On" },
          { key: "fTexts", label: "Texts", kind: "toggle", display: "On" },
          { key: "fDrawingObjects", label: "Drawing Objects", kind: "toggle", display: "On" },
        ],
      },
      {
        title: "Document",
        fields: [
          ...
          { key: "gridType", label: "Grid Type", kind: "dropdown", options: GRID_TYPES, display: "Grid Dot" },
          { key: "boldGridType", label: "Bold Grid Type", kind: "dropdown", options: GRID_TYPES, display: "Grid" },
          { key: "boldGridRatio", label: "Bold Grid Ratio", kind: "number", display: "5" },
          ...
          { key: "snapSize", label: "Snap Size", kind: "number", unit: "mil", display: "2" },
          { key: "snap", label: "Snap", kind: "toggle", bind: "doc:snap", display: "On" },
          { key: "altSnapSize", label: "Alt Snap Size", kind: "number", unit: "mil", display: "1" },
          { key: "highlight", label: "Highlight", kind: "toggle", display: "On" },
        ],
      },
      {
        title: "Common Setting",
        fields: [
          { key: "startTrackWidth", label: "Start Track width", kind: "number", unit: "mil", display: "8" },
          { key: "trackWidth", label: "Track Width", kind: "number", unit: "mil", display: "10" },
          { key: "startViaSize", label: "Start Via size", kind: "number", unit: "mil", display: "24" },
          { key: "viaOuter", label: "Via Outside diameter", kind: "number", unit: "mil", display: "24" },
          { key: "viaInner", label: "VIa Inside Diameter", kind: "number", unit: "mil", display: "12" },
          { key: "routingMode", label: "Routing Mode", kind: "dropdown", options: ROUTING_MODES, display: "45° Diagonal" },
          { key: "trackOpt", label: "Current Track Path Optimization", kind: "toggle", display: "On" },
          { key: "removeLoop", label: "Remove Loop", kind: "toggle", display: "On" },
          { key: "hideCopper", label: "Hide Copper Region", kind: "toggle", display: "Off" },
          { key: "moveFootprint", label: "Move Footprint The Wire Follows", kind: "toggle", display: "On" },
          { key: "rotationObjects", label: "Rotation Objects", kind: "number", unit: "°", display: "90" },
          { key: "minTrackCorners", label: "Minimum Track Corners", kind: "number", display: "0" },
        ],
      },
    ],
  },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "silkColor", label: "Silk Screen Color", kind: "color", display: "#FFFFFF" },
        ],
      },
      {
        title: "Basic Properties",
        fields: [
          ...
          { key: "footprint", label: "Footprint", kind: "text", bind: "obj:footprint", display: "—" },
          { key: "addBom", label: "Add into BOM", kind: "toggle", display: "Yes" },
          { key: "model3d", label: "3d Model Title", kind: "text", display: "—" },
        ],
      },
      {
        title: "Key Properties",
        fields: [
          ...
          { key: "supplier", label: "Supplier", kind: "text", display: "—" },
          { key: "supplierPart", label: "Supplier Part", kind: "text", display: "—" },
          { key: "value", label: "Value", kind: "text", display: "—" },
        ],
      },
      { title: "More Properties", fields: [{ key: "addProperty", label: "Add Property", kind: "action", display: "+ Add" }] },
    ],
    ...
    sections: [
      {
        ...
        fields: [
          { key: "layer", label: "Layer", kind: "dropdown", optionsToken: "layers", bind: "obj:layer" },
          { key: "number", label: "Number", kind: "text", display: "1" },
      ...
      },
      {
        title: "Size",
        fields: [
          { key: "general", label: "General", kind: "toggle", display: "On" },
          ...
          { key: "cornerRadiusRatio", label: "Corner Radius Ratio", kind: "number", unit: "%", display: "0" },
        ],
      },
      {
        title: "Location",
      ...
      },
      {
        ...
        fields: [
          { key: "expMode", label: "General", kind: "dropdown", options: EXP_MODES, display: "General" },
          { key: "expCustom", label: "Custom", kind: "toggle", display: "Off" },
          { key: "solderMaskExp", label: "Solder Mask Expansion", kind: "number", unit: "mil", display: "4" },
          { key: "pasteMaskExp", label: "Paste Mask Expansion", kind: "number", unit: "mil", display: "0" },
        ],
      },
      {
        title: "Thermal",
        fields: [
          { key: "thermalGeneral", label: "General", kind: "dropdown", options: EXP_MODES, display: "General" },
          { key: "thermalCustom", label: "Custom", kind: "toggle", display: "Off" },
          { key: "padConnection", label: "Pad Connection", kind: "dropdown", options: ["Direct", "Thermal Relief", "None"], display: "Thermal Relief" },
        ],
      },
      {
        title: "Pin Delay",
        fields: [{ key: "pinLength", label: "Pin Length", kind: "number", unit: "mil", display: "0" }],
      },
    ],
  },
  Vias: {
    ...
    sections: [
      {
        title: "Property",
        fields: [
          { key: "throughVia", label: "Through Via", kind: "toggle", display: "On" },
          { key: "blindBuried", label: "Blind Or buried Via", kind: "dropdown", options: VIA_KINDS, display: "Through" },
    ...
    sections: [
      {
        title: "Property",
        fields: [
          { key: "type", label: "Type", kind: "dropdown", options: ["Rectangle", "Polygon", "Circle"], display: "Rectangle" },
          { key: "layer", label: "Layer", kind: "dropdown", optionsToken: "layers", bind: "obj:layer" },
          { key: "lineWidth", label: "Line width", kind: "number", unit: "mil", bind: "obj:width", display: "10" },
          { key: "id", label: "ID", kind: "readonly", display: "—" },
          { key: "locked", label: "Locked", kind: "toggle", bind: "obj:locked", display: "Off" },
      ...
      },
      {
        ...
        fields: [
          ...
          { key: "cornerRadius", label: "Corner Radius", kind: "number", unit: "mil", display: "0" },
          { key: "rotation", label: "Rotation", kind: "number", unit: "°", bind: "obj:rotation", display: "0" },
        ],
      },
      { title: "Combination", fields: [{ key: "group", label: "Group", kind: "action", display: "Group" }] },
    ...
    sections: [
      {
        ...
        fields: [
          ...
          { key: "layer", label: "Layer", kind: "dropdown", optionsToken: "layers", bind: "obj:layer" },
          { key: "mirror", label: "Mirror", kind: "toggle", display: "Off" },
        ],
      },
      {
        title: "Font Type",
        fields: [
          { key: "fontFamily", label: "Font Family", kind: "dropdown", options: ["Inter", "Arial", "Roboto", "Courier"], display: "Inter" },
          { key: "strokeWidth", label: "Stroke Width", kind: "number", unit: "mil", display: "6" },
          { key: "height", label: "Height", kind: "number", unit: "mil", bind: "obj:height", display: "60" },
          { key: "inverted", label: "Inverted", kind: "toggle", display: "Off" },
          { key: "invertedExpansion", label: "Inverted Expansion", kind: "number", unit: "mil", display: "0" },
        ],
      },
      {
        title: "Location",
      ...
      { title: "Combination", fields: [{ key: "group", label: "Group", kind: "action", display: "Group" }] },
      { title: "Silk", fields: [{ key: "silkColor", label: "Silk Screen Color", kind: "color", display: "#FFFFFF" }] },
    ],
  },
};
