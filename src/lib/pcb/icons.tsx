...
export const ic: Record<string, string> = {
  ...
  v3dPersp: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"><path d="M7 5l13 2v10l-13 2z"/><path d="M7 5L4 8v8l3 3"/></svg>',
  v3dOrtho: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"><rect x="4" y="5" width="16" height="14" rx="1.5"/><path d="M4 9h16"/></svg>',
  v3dExplode: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round" stroke-linecap="round"><path d="M12 2l7 4-7 4-7-4 7-4z"/><path d="M5 13l7 4 7-4"/><path d="M5 19l7 3 7-3"/></svg>',
  ...
  // ── Toolbar (Schematic) — Figma icon set ────────────────────────────────
  tSaveAll: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"><path d="M4 4h10l3 3v11H4z"/><path d="M7 4v4h7"/><path d="M9 21h9a2 2 0 0 0 2-2V9" stroke-linecap="round"/></svg>',
  tAlignGrid: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><rect x="3" y="3" width="18" height="18" rx="2"/><path d="M9 3v18M15 3v18M3 9h18M3 15h18"/><rect x="6" y="6" width="3" height="3" fill="currentColor" stroke="none"/><rect x="12" y="12" width="3" height="3" fill="currentColor" stroke="none"/></svg>',
  tSelectVisible: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 6h18M6 12h12M10 18h4"/></svg>',
  tViewDetails: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="4" width="18" height="16" rx="2"/><path d="M3 9h18M8 4v16"/></svg>',
  tFitAll: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M4 9V5a1 1 0 0 1 1-1h4M20 9V5a1 1 0 0 0-1-1h-4M4 15v4a1 1 0 0 0 1 1h4M20 15v4a1 1 0 0 1-1 1h-4"/></svg>',
  ...
  tDiode: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round" stroke-linecap="round"><path d="M3 12h5M16 12h5"/><path d="M8 6v12l8-6z" fill="currentColor"/><path d="M16 6v12"/></svg>',
  tResistor: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linejoin="round" stroke-linecap="round"><path d="M2 12h3l1.5-4 3 8 3-8 3 8 1.5-4H22"/></svg>',
  tCapacitor: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"><path d="M3 12h7M14 12h7M10 6v12M14 6v12"/></svg>',
  tNetFlag: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M6 21V4h11l-3 3.5L17 11H6"/></svg>',
  tVcc5v: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M12 4l-4 4h8z" fill="currentColor"/><path d="M12 8v12"/><path d="M9 14h6M12 12v4" stroke-width="1.5"/></svg>',
  tShortFlag: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round"><path d="M4 12h12"/><circle cx="4" cy="12" r="1.8" fill="currentColor" stroke="none"/><path d="M16 9v6"/></svg>',
  tPort: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 9h11l4 3-4 3H3z"/></svg>',
  tText: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"><path d="M5 7V5h14v2M12 5v14M9 19h6"/></svg>',
  tConvertPcb: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round" stroke-linecap="round"><rect x="3" y="4" width="8" height="8" rx="1.2"/><rect x="13" y="12" width="8" height="8" rx="1.2"/><path d="M11 8h4M17 12v-2M9 16l-2-2 2-2"/></svg>',
  tJlcpcb: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"><rect x="3" y="6" width="18" height="12" rx="1.5"/><path d="M7 10h2M11 10h6M7 14h10" stroke-linecap="round"/><circle cx="6" cy="14" r=".8" fill="currentColor" stroke="none"/></svg>',
  tGenBlock: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round" stroke-linecap="round"><rect x="4" y="7" width="11" height="10" rx="1.2"/><path d="M15 10h4M15 14h4M19 8v8"/><path d="M7 5h5" stroke-dasharray="2 2"/></svg>',
  tPgnd: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.9" stroke-linecap="round"><path d="M12 4v9"/><path d="M5 13h14M8 16h8M11 19h2"/></svg>',
  tAgnd: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round" stroke-linecap="round"><path d="M12 4v9"/><path d="M5 13l7 7 7-7z" fill="currentColor"/></svg>',
  tBringFront: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"><rect x="7" y="7" width="10" height="10" rx="1.5" fill="currentColor" stroke="none"/><rect x="3" y="3" width="10" height="10" rx="1.5" fill="none"/><rect x="11" y="11" width="10" height="10" rx="1.5" fill="none"/></svg>',
  tSendBack: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linejoin="round"><rect x="3" y="3" width="10" height="10" rx="1.5" fill="currentColor" stroke="none"/><rect x="11" y="11" width="10" height="10" rx="1.5" fill="currentColor" stroke="none"/><rect x="7" y="7" width="10" height="10" rx="1.5" fill="none"/></svg>',
  tRotRight: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M21 12a9 9 0 1 1-3-6.7L21 8"/><path d="M21 3v5h-5"/></svg>',
  tRotLeft: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12a9 9 0 1 0 3-6.7L3 8"/><path d="M3 3v5h5"/></svg>',
  tFlipV: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M12 3v18"/><path d="M5 8l-2-2 2-2M19 8l2-2-2-2" opacity="0"/><path d="M4 9l8 4-8 4z" fill="currentColor"/><path d="M20 9l-8 4 8 4z"/></svg>',
  tFlipH: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12h18"/><path d="M9 4l4 8L5 12z" fill="currentColor"/><path d="M9 20l4-8-8 0z"/></svg>',
  tFootMgr: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="4" y="8" width="16" height="10" rx="1.5"/><path d="M8 8V5M16 8V5M9 18v2M15 18v2" stroke-linecap="round"/><circle cx="12" cy="13" r="1.5" fill="currentColor" stroke="none"/></svg>',
  tDevMgr: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="6" y="6" width="12" height="12" rx="1.5"/><path d="M9 6V3M15 6V3M9 21v-3M15 21v-3M6 9H3M6 15H3M21 9h-3M21 15h-3" stroke-linecap="round"/><circle cx="12" cy="12" r="1.6" fill="currentColor" stroke="none"/></svg>',
  tBoolPreserve: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="9" cy="12" r="5" fill="currentColor" opacity=".35" stroke="none"/><circle cx="15" cy="12" r="5" fill="currentColor" opacity=".35" stroke="none"/><circle cx="9" cy="12" r="5"/><circle cx="15" cy="12" r="5"/></svg>',
  tBoolMerge: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M9 7a5 5 0 0 0 0 10 5 5 0 0 0 6 0 5 5 0 0 0 0-10 5 5 0 0 0-6 0z" fill="currentColor" stroke="none"/><circle cx="9" cy="12" r="5"/><circle cx="15" cy="12" r="5"/></svg>',
  tBoolSubtract: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="9" cy="12" r="5" fill="currentColor" stroke="none"/><circle cx="15" cy="12" r="5" fill="var(--color-bg-surface)" stroke="currentColor"/></svg>',
  tBoolExclude: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M9 7a5 5 0 1 0 0 10z" fill="currentColor" stroke="none"/><path d="M15 7a5 5 0 1 1 0 10z" fill="currentColor" stroke="none"/><circle cx="9" cy="12" r="5"/><circle cx="15" cy="12" r="5"/></svg>',
  ...
  tNetLabel: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M3 12h6"/><path d="M9 7h10a1 1 0 0 1 1 1v8a1 1 0 0 1-1 1H9l-3.2-5z"/></svg>',
  tSettings: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="12" cy="12" r="3"/><path d="M19 12a7 7 0 0 0-.1-1.2l2-1.6-2-3.4-2.4.9a7 7 0 0 0-2-1.2L14 3h-4l-.5 2.5a7 7 0 0 0-2 1.2L5.1 5.8 3.1 9.2l2 1.6A7 7 0 0 0 5 12a7 7 0 0 0 .1 1.2l-2 1.6 2 3.4 2.4-.9a7 7 0 0 0 2 1.2L10 21h4l.5-2.5a7 7 0 0 0 2-1.2l2.4.9 2-3.4-2-1.6c.1-.4.1-.8.1-1.2z" stroke-linejoin="round" stroke-linecap="round"/></svg>',
  ...
  tDimension: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6" stroke-linecap="round" stroke-linejoin="round"><path d="M4 14V10M20 14V10M4 12h16M4 18l-1.5-1.5M4 18l1.5-1.5M20 18l-1.5-1.5M20 18l1.5-1.5"/></svg>',
  tBoardOutline: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linejoin="round"><rect x="3" y="5" width="18" height="14" rx="2" stroke-dasharray="3 3"/></svg>',
