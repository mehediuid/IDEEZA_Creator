...
import { PcbBoardMesh, PcbComponentMesh } from "@/components/pcb/pcb-meshes";
...
function SceneContents({
  ...
  return (
    <>
      ...
      />
      {/* HDR environment loads from a CDN — isolate it in its own Suspense so
          a slow/blocked network can never blank the whole scene. */}
...
// ─────────────────────────────────────────────────────────────────────
// Meshes — PcbBoardMesh / PcbComponentMesh are shared with the PCB module's
// 3D tab (see @/components/pcb/pcb-meshes); only the enclosure mesh is
// preview-specific (transparency + transform gizmo).
// ─────────────────────────────────────────────────────────────────────
